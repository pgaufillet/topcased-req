...
public class RequirementActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(RequirementEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        @Override
        public void run()
        {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(RequirementEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        @Override
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_RequirementEditor_menu"), "org.topcased.requirementMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
