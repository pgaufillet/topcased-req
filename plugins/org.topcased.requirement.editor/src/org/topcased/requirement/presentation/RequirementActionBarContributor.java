...
/**
 * This is the action bar contributor for the Requirement model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class RequirementActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener
{
    /**
     ...
     * @generated
     */
    protected IAction showPropertiesViewAction = new Action(RequirementEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
    {
        @Override
        public void run()
        {
     ...
     * @generated
     */
    protected IAction refreshViewerAction = new Action(RequirementEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
    {
        @Override
    ...
    public void contributeToMenu(IMenuManager menuManager)
    {
        ...
        IMenuManager submenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_RequirementEditor_menu"), "org.topcased.requirementMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        //
        createChildMenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
        submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
    ...
    public void menuAboutToShow(IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

        submenuManager = new MenuManager(RequirementEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
