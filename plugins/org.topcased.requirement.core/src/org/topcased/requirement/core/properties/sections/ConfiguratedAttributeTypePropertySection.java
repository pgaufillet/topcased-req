 ...
 */
public class ConfiguratedAttributeTypePropertySection extends AbstractStringPropertySection
{
    /**
    ...
    {
        return Messages.getString("ConfiguratedAttributeTypePropertySection.0"); //$NON-NLS-1$
    }
    ...
    {
        return RequirementPackage.eINSTANCE.getConfiguratedAttribute_Type();
    }
    ...
    {
        ConfiguratedAttribute attribute = (ConfiguratedAttribute) getEObject();
