...
/**
 * Handler of the Tree command
 * 
 * @author <a href="mailto:maxime.audrain@c-s.fr">Maxime AUDRAIN</a>
 * 
 */
public class TreeHandler extends AbstractHandlerWithState
{
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException
    {
        ...
        tableCmd.getState(RegistryToggleState.STATE_ID).setValue(!(Boolean) event.getCommand().getState(RegistryToggleState.STATE_ID).getValue());
