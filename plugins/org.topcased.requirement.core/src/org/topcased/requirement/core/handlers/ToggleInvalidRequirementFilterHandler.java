...
import org.topcased.requirement.core.filters.InvalidRequirementFilter;
import org.topcased.requirement.core.utils.RequirementHelper;
import org.topcased.requirement.core.views.current.CurrentPage;

public class ToggleInvalidRequirementFilterHandler extends AbstractHandlerWithState
{

    private final InvalidRequirementFilter invalidReqFilter = new InvalidRequirementFilter();
    ...
    private class FilterDisposeListener implements DisposeListener
    {
        ...
        public void widgetDisposed(DisposeEvent e)
        {
            ...
            try
            {
                ...
                viewer.removeFilter(ToggleInvalidRequirementFilterHandler.this.invalidReqFilter);
                invalidReqFilter.emptyCache();
            }
