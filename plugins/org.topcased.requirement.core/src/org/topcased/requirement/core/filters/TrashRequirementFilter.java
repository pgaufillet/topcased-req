 ...
 * 
 */
public class TrashRequirementFilter extends ViewerFilter implements ITrashRequirementFilter
{
    ...
    public boolean select(Viewer viewer, Object parentElement, Object element)
    {
        ...
        // Requirements that refer to a trash requirement are visible.
        else if (element instanceof Requirement)
        {
            // Not optimal : refersToTrash already runs through
            // the ObjectAttributes.
            EObject req = (EObject) element;
            result = RequirementUtils.refersToTrash(req);
            cache.put(element, result);
        }
