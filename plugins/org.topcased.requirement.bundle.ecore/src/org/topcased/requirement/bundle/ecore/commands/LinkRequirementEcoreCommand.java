...
/**
 * The Class LinkRequirementEcoreCommand.
 */
public class LinkRequirementEcoreCommand extends AbstractCommand
{
    ...
    /**
     * Instantiates a new link requirement ecore command.
     * 
     * @param ltargetModel the ltarget model
     * @param requirementModelPath the requirement model path
     */
    public LinkRequirementEcoreCommand(Resource ltargetModel, IPath requirementModelPath)
    {
