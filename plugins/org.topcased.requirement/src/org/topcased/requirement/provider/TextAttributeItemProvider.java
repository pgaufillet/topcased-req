...
/**
 * This is the item provider adapter for a {@link org.topcased.requirement.TextAttribute} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TextAttributeItemProvider extends AttributeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource, IItemColorProvider
{
     ...
     * @generated
     */
    public TextAttributeItemProvider(AdapterFactory adapterFactory)
    {
    ...
    /**
     * This returns TextAttribute.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    ...
    {
        String label = ((TextAttribute) object).getName();
        String value = ((TextAttribute) object).getValue();
    ...
    public void notifyChanged(Notification notification)
    {
        ...
        switch (notification.getFeatureID(TextAttribute.class))
        {
            case RequirementPackage.TEXT_ATTRIBUTE__VALUE:
