...
public class AttributeValueImpl extends EObjectImpl implements AttributeValue
{
    ...
    {
        return RequirementPackage.Literals.ATTRIBUTE_VALUE;
    }
    ...
    public void setValue(String newValue)
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RequirementPackage.ATTRIBUTE_VALUE__VALUE, oldValue, value));
    }
