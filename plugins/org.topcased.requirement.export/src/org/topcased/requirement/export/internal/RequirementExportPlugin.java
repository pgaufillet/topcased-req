 ...
 */
public class RequirementExportPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.topcased.requirement.export"; //$NON-NLS-1$

	// The shared instance
	private static RequirementExportPlugin plugin;
	
	/**
	 * The constructor
	 */
	public RequirementExportPlugin() {
	}
	 ...
	 */
	public static RequirementExportPlugin getDefault() {
		return plugin;
	}
