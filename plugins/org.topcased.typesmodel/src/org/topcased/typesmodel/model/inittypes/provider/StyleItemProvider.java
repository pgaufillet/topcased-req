...
/**
 * This is the item provider adapter for a {@link org.topcased.typesmodel.model.inittypes.Style} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Style_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Style_label_feature", "_UI_Style_type"),
				 InittypesPackage.Literals.STYLE__LABEL,
				 true,
				 false,
				 false,
    ...
    public void notifyChanged(Notification notification)
    {
		...
		switch (notification.getFeatureID(Style.class)) {
			case InittypesPackage.STYLE__LABEL:
