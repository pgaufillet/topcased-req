...
/**
 * This is the item provider adapter for a {@link org.topcased.typesmodel.model.inittypes.Regex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Regex_expression_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Regex_expression_feature", "_UI_Regex_type"),
                 InittypesPackage.Literals.REGEX__EXPRESSION,
                 true,
                 false,
                 false,
    ...
    public String getText(Object object)
    {
        ...
        String label = "";
        if (((Regex)object).getName() != null)
        {
            label += ((Regex)object).getName();
        }
    ...
    public void notifyChanged(Notification notification)
    {
        ...
        {
            case InittypesPackage.REGEX__EXPRESSION:
