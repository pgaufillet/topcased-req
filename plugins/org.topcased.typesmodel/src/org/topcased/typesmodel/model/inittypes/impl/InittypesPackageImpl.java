...
public class InittypesPackageImpl extends EPackageImpl implements InittypesPackage
{
	 ...
	 * @generated
	 */
	public EReference getDocumentType_DeletionParameters() {
		return (EReference)documentTypeEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EClass getDeletionParameters() {
		return deletionParametersEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDeletionParameters_FilterRegexAttributes() {
		return (EReference)deletionParametersEClass.getEStructuralFeatures().get(3);
	}
    ...
    public void createPackageContents()
    {
		...
		createEReference(documentTypeEClass, DOCUMENT_TYPE__DELETION_PARAMETERS);
    ...
    public void initializePackageContents()
    {
		...
		initEReference(getDocumentType_DeletionParameters(), this.getDeletionParameters(), null, "deletionParameters", null, 0, 1, DocumentType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
